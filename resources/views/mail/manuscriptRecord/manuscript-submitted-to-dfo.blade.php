<x-mail::message>
    ...
    *(le français suit)*
    ...
    publishing. A new publication record has been created in the Open Science
    Portal and can be found at the link below.
    ...
    publication. Un nouveau registre de publication a été créé dans le Portail
    de la science ouverte et peut être consulté au lien ci-dessous.
