...
export type ManuscriptRecordStatus = "draft" | "in_review" | "reviewed" | "submitted" | "accepted" | "withdrawn";
...
export interface ManuscriptRecord extends BaseManuscriptRecord {
    ...
    pls_en:                  string | null;
    pls_fr:                  string | null;
    scientific_implications: string | null;
    regions_and_species:     string | null;
...
export class ManuscriptRecordService {
    ...
    public static async create(data: BaseManuscriptRecord){
        const response = await http.post<BaseManuscriptRecord,R>(`${this.baseURL}`, data);
        return response.data;
    ...
    */
    public static async save(data: ManuscriptRecord){
        const response = await http.put<ManuscriptRecord,R>(`${this.baseURL}/${data.id}`, data);
        return response.data;
    }
