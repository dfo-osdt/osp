...
declare global {
  ...
  const useManuscriptStore: typeof import('./stores/ManuscriptStore')['useManuscriptStore']
  ...
  const usePublicationStore: typeof import('./stores/PublicationStore')['usePublicationStore']
  const useQuasar: typeof import('quasar')['useQuasar']
  const useRafFn: typeof import('@vueuse/core')['useRafFn']
  const useRefHistory: typeof import('@vueuse/core')['useRefHistory']
  const useRegionStore: typeof import('./stores/RegionStore')['useRegionStore']
...
namespace _ComponentCustomProperties {
  const { $, $$, $computed, $customRef, $ref, $shallowRef, $toRef }: typeof import('vue/macros')
  ...
  const { useAuthStore }: typeof import('./stores/AuthStore')
  const { useFileRejectionHandler }: typeof import('./composables/useFileRejectionHandler')
  const { useFunctionalAreaStore }: typeof import('./stores/FunctionalAreaStore')
  const { useFunderStore }: typeof import('./stores/FunderStore')
  const { useHead, useSeoMeta }: typeof import('@vueuse/head')
  const { useI18n }: typeof import('vue-i18n')
  const { useLocaleDate }: typeof import('./composables/useLocaleDate')
  const { useLocaleStore }: typeof import('./stores/LocaleStore')
  const { useLocaleTimeAgo }: typeof import('./composables/useLocaleTimeAgo')
  const { useManagementReviewStepStore }: typeof import('./stores/ManagementReviewStepStore')
  const { useManuscriptStore }: typeof import('./stores/ManuscriptStore')
  const { usePublicationStore }: typeof import('./stores/PublicationStore')
  const { useRegionStore }: typeof import('./stores/RegionStore')
}
declare module 'vue' {
